    ...
    <section class="py-5 section-cover">
        <div class="container d-flex justify-content-between h-100">
            <div class="container flex-lg-grow-1 text-white d-none d-md-flex flex-column justify-content-center">
                ...
                <p class="lead">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis sunt sed, eum reprehenderit adipisci ad.
                </p>
            </div>
            <div class="container flex-grow-1 w-50 bg-white rounded d-flex flex-column text-center justify-content-around">
                <h3>LOG IN</h3>   
                <form class="d-flex flex-column align-items-stretch my-2">
                    <input type="email" class="form-control w-100" placeholder="Email">
                        <input type="password" class="form-control w-100 my-3" placeholder="Password" id="password">
                        <div class="mb-3 d-flex ms-1">
                        <input type="checkbox" class="form-check" id="togglePassword"><label class="ms-2">Show Password</label>
                        </div>
